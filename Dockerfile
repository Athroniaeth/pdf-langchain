...
CMD ["conda", "run", "-n", "chat_pdf", "python", "src", "run", "--host", "0.0.0.0", "--ssl-keyfile", "/etc/letsencrypt/live/pierrechaumont.fr/privkey.pem", "--ssl-certfile", "/etc/letsencrypt/live/pierrechaumont.fr/fullchain.pem"]
